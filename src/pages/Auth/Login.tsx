...
import { Eye, EyeOff, Briefcase, User, Building2, Shield } from 'lucide-react';
...
export default function Login() {
  ...
  const roleOptions = [
    ...
    { value: 'admin', label: 'Administrator', icon: Shield, description: 'Platform management' }
  ];
              ...
              {roleOptions.map((option) => (
                ...
                >
                  <input
                    ...
                    onChange={(e) => setRole(e.target.value.toLowerCase() as UserRole)}
                    className="sr-only"
                  />
